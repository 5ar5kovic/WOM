...
/**
 * Data Mapper implementation for Application_Model_Korisnik
 *
 * @package Application_Model
 * @subpackage Mapper
 * @author SpecNaz Team 9815
 */
class Application_Model_Mapper_Korisnik extends Application_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Application_Model_Korisnik $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Application_Model_Korisnik) {
     ...
     *
     * @return Application_Model_DbTable_Korisnik
     */
     ...
     *
     * @param Application_Model_Korisnik $model The model to delete
     ...
     */
    public function save(Application_Model_Korisnik $model,
     ...
     * @param Application_Model_Korisnik|null $model
     * @return Application_Model_Korisnik|null The object provided or null if not found
     */
     ...
     * @param Application_Model_Korisnik|null $entry The object to load the data into, or null to have one created
     * @return Application_Model_Korisnik The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Application_Model_Korisnik();
        }
