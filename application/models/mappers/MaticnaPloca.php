...
/**
 * Data Mapper implementation for Application_Model_MaticnaPloca
 *
 * @package Application_Model
 * @subpackage Mapper
 * @author SpecNaz Team 9815
 */
class Application_Model_Mapper_MaticnaPloca extends Application_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Application_Model_MaticnaPloca $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Application_Model_MaticnaPloca) {
     ...
     *
     * @return Application_Model_DbTable_MaticnaPloca
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Application_Model_DbTable_MaticnaPloca');
        }
     ...
     *
     * @param Application_Model_MaticnaPloca $model The model to delete
     ...
     */
    public function save(Application_Model_MaticnaPloca $model,
     ...
     * @param Application_Model_MaticnaPloca|null $model
     * @return Application_Model_MaticnaPloca|null The object provided or null if not found
     */
     ...
     * @param Application_Model_MaticnaPloca|null $entry The object to load the data into, or null to have one created
     * @return Application_Model_MaticnaPloca The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Application_Model_MaticnaPloca();
        }
