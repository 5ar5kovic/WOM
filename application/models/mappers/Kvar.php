...
/**
 * Data Mapper implementation for Application_Model_Kvar
 *
 * @package Application_Model
 * @subpackage Mapper
 * @author SpecNaz Team 9815
 */
class Application_Model_Mapper_Kvar extends Application_Model_Mapper_MapperAbstract
{
    /**
     * Returns an array, keys are the field names.
     *
     * @param Application_Model_Kvar $model
     * @return array
     */
    public function toArray($model)
    {
        if (! $model instanceof Application_Model_Kvar) {
     ...
     *
     * @return Application_Model_DbTable_Kvar
     */
    public function getDbTable()
    {
        if ($this->_dbTable === null) {
            $this->setDbTable('Application_Model_DbTable_Kvar');
        }
     ...
     *
     * @param Application_Model_Kvar $model The model to delete
     ...
     */
    public function save(Application_Model_Kvar $model,
     ...
     * @param Application_Model_Kvar|null $model
     * @return Application_Model_Kvar|null The object provided or null if not found
     */
     ...
     * @param Application_Model_Kvar|null $entry The object to load the data into, or null to have one created
     * @return Application_Model_Kvar The model with the data provided
     */
    public function loadModel($data, $entry)
    {
        if ($entry === null) {
            $entry = new Application_Model_Kvar();
        }
