...
<div class="wrapper">
  ...
  <!-- including aside -->
  <div w3-include-html="pages/aside.html"></div> 
  <script>
	includeHTML();
  </script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row col-lg-12">
          <!-- Left col -->
          <section class="connectedSortable col-lg-7">
          ...
          <!-- /.Left col -->
          	...
          	<section class="connectedSortable col-lg-5">
            <!-- Calendar -->
